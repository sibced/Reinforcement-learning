    ...
    *,
    ...
    with InvertedDoublePendulumBulletEnv() as env:
        ...
        for iteration in range(n_iteration):
            ...
            # print(f"{rewards_torch.shape=}")
            # print(f"{observations_torch.shape=}")
            # print(f"{actions_torch.shape=}")
            # print(f"{rewards_to_go.shape=}")
            ...
            for epoch in range(n_epochs):
                ...
                for batch_idx, (o, u, rtg, adv) in enumerate(dataloader):
                ...
                writer.add_scalar(  # log the value that should increase
                    prefix + "PolicyLoss", -loss_clip_lst.mean(), glob_step
                )
                writer.add_scalar(
                    prefix + "ValueLoss", loss_value_lst.mean(), glob_step
                )
